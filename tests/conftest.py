...
@pytest.fixture
def lmod_environment(tmpdir):
    """Set up a mock Lmod environment directory for testing."""
    # Create a temporary directory to simulate the Lmod environment
    lmod_dir = tmpdir.ensure('lmod', dir=True)
    print('---------- lmod_environment:', lmod_dir, type(lmod_dir))

    return lmod_dir

@pytest.fixture
def lmod_environment_loaded(monkeypatch, lmod_environment):
    """Set up a mock Lmod environment with the proper MODULEPATH for testing."""
    monkeypatch.setenv('MODULEPATH', str(lmod_environment))
    return lmod_environment

@pytest.fixture
def lmod_environment2(tmpdir):
    """Set up a different mock Lmod environment directory for testing."""
    # Create a temporary directory to simulate the Lmod environment
    lmod_dir = tmpdir.ensure('lmod2', dir=True)
    return lmod_dir

@pytest.fixture
def lmod_environment_loaded2(monkeypatch, lmod_environment2):
    """Set up a different mock Lmod environment with the proper MODULEPATH for testing."""
    monkeypatch.setenv('MODULEPATH', str(lmod_environment2))
    return lmod_environment2
...
@pytest.fixture
def module_factory(
        tmpdir, lmod_environment_loaded
    ) -> Callable[[str, str, str, list[str], dict[str, str]], tuple[str, str]]:
...
@pytest.fixture
def jupyter_server_module1(module_factory, lmod_environment_loaded) -> Generator[ModuleInfo, None, None]:
...
@pytest.fixture
def jupyter_server_module2(module_factory, lmod_environment_loaded) -> Generator[ModuleInfo, None, None]:
    """Add a mock Jupyter server module to the MODULEPATH."""
...
@pytest.fixture
def jupyter_server_module3(module_factory, lmod_environment_loaded) -> Generator[ModuleInfo, None, None]:
    """Add a mock Jupyter server module to the MODULEPATH."""
...
@pytest.fixture
def jupyter_server_module_sub1(module_factory, lmod_environment) -> Generator[ModuleInfo, None, None]:
    """Add a mock Jupyter server module to the MODULEPATH."""
    mod_name, mod_ver, py_ver = 'jupyter-server', '3', '3.8'
    modulefile_path, root_path = module_factory(
        mod_name, mod_ver, JUPYTER_SERVER_MODULE_TEMPLATE_LUA,
...
@pytest.fixture
def ijulia_module1(module_factory, lmod_environment_loaded, mock_julia) -> Generator[ModuleInfo, None, None]:
...
@pytest.fixture
def ijulia_module2(module_factory, lmod_environment_loaded, mock_julia) -> Generator[ModuleInfo, None, None]:
    """Add a mock IJulia module to the MODULEPATH."""
...
@pytest.fixture
def ijulia_module3(module_factory, lmod_environment_loaded, mock_julia) -> Generator[ModuleInfo, None, None]:
    """Add a mock IJulia module to the MODULEPATH."""
...
@pytest.fixture
def octave_module1(module_factory, lmod_environment_loaded) -> Generator[ModuleInfo, None, None]:
...
@pytest.fixture
def rootkernel_module1(module_factory, lmod_environment_loaded) -> Generator[ModuleInfo, None, None]:
...
@pytest.fixture
def irkernel_module1(module_factory, lmod_environment_loaded, mock_r) -> Generator[ModuleInfo, None, None]:
...
@pytest.fixture
def cling_module1(module_factory, lmod_environment_loaded) -> Generator[ModuleInfo, None, None]:
...
@pytest.fixture
def jpk_bash_module1(module_factory, lmod_environment_loaded) -> Generator[ModuleInfo, None, None]:
